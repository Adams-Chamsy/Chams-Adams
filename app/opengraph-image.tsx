    ...
    (
      <div
        style={{
          ...
          background:
            'radial-gradient(ellipse at 50% 45%, #1E1A14 0%, #0A0A0A 60%, #050403 100%)',
        }}
      >
        {/* next/image ne fonctionne pas dans ImageResponse (Satori Edge Runtime) —
            `<img>` est la seule option ici, lint désactivée pour cette ligne. */}
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          alt=""
          width={280}
          height={252}
          src={`data:image/svg+xml;utf8,${encodeURIComponent(SVG_MONOGRAM)}`}
        />
        <div
          style={{
            display: 'flex',
